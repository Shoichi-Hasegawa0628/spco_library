...
(double srr, double srt, double str, double stt){
  ...
  bool GridSlamProcessor::processScan(const RangeReading & reading, int adaptParticles){
	...
	m_infoStream << "update frame " <<  m_readingCount << endl
      ...
      std::ifstream ifs("/root/Fetch/catkin_ws/src/spco_library/rgiro_spco2_slam/data/output/trialname.txt");
      if(ifs.fail()){
      ...
      string filename("/root/Fetch/catkin_ws/src/spco_library/rgiro_spco2_slam/data/output/" );
      string filename2;
      string filename3;
      string filename4;
      stringstream ss;

...
datafolder   = "/root/RULO/catkin_ws/src/spco_library/rgiro_spco2_slam/data/output/"        #PATH of data out put folder
...
datasetfolder = "/root/RULO/catkin_ws/src/spco_library/rgiro_spco2_slam/data/rosbag/"   #training data set folder

...
datafolder   = "/root/Fetch/catkin_ws/src/spco_library/rgiro_spco2_slam/data/output/"        #PATH of data out put folder
...
datasetfolder = "/root/Fetch/catkin_ws/src/spco_library/rgiro_spco2_slam/data/rosbag/"   #training data set folder
...
scantopic     = ["hsrb/base_scan"] #, "base_scan _odom_frame:=odom_combined"]
